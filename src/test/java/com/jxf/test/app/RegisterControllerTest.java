...
@WebAppConfiguration
public class RegisterControllerTest extends AppControllerTest {
	...
	public void testSubmit() throws Exception {
		...
		MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/app/wyjt/register/submit" );
		RegisterSubmitRequestParam reqParam = new RegisterSubmitRequestParam();
		reqParam.setPhoneNo("18010196216");
		reqParam.setPassword("123456");
		reqParam.setSmsVerifyCode("1234");
