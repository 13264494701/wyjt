 ...
 */
public class UpdateMessageUtils2 {

	private static Logger log = LoggerFactory.getLogger(UpdateMessageUtils2.class);
...
//		importMessage(1L, 2000L);
	...
	public static int importMessage(Long startId, Long endId) {
		...
		ResultSet rs = null;
		String countsql = "select * from MEM_MEMBER_MESSAGE a where a.id >= ? and a.id <= ?";
