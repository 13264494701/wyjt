 ...
 * @功能说明:消息数据迁移
 */
public class ImportUpdateMessageUtils5 {

	private static Logger log = LoggerFactory.getLogger(ImportUpdateMessageUtils5.class);
	...
	public static int importMessage() {
		...
		ResultSet rs = null;
		String countsql = "select * from MEM_MEMBER_MESSAGE where type in('1','2','3','4','5','6','7','8','10','11','12','13','14') and create_time < '2019-02-13'";
