 ...
 * @功能说明:消息数据迁移
 */
public class ImportUpdateMessageUtils6 {

	private static Logger log = LoggerFactory.getLogger(ImportUpdateMessageUtils6.class);
	...
	public static int importMessage() {
		...
		ResultSet rs = null;
		String countsql = "select * from MEM_MEMBER_MESSAGE where type in ('17','18','19','22','23','24','25','31','33') and create_time < '2019-02-13'";
