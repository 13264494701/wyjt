 ...
 * @功能说明:消息数据迁移
 */
public class ImportUpdateMessageUtils4 {

	private static Logger log = LoggerFactory.getLogger(ImportUpdateMessageUtils4.class);
	...
	public static int importMessage() {
		...
		ResultSet rs = null;
		String countsql = "select * from MEM_MEMBER_MESSAGE where type = 32 and create_time < '2019-02-13'";
