 ...
 * @功能说明:会员的账单流水迁移
 */
public class ImportMemberActTrxUtils2016 {
	
	private static Logger log = LoggerFactory.getLogger(ImportMemberActTrxUtils2016.class);
	...
	public static int importTrx(Long startId, Long endId) {
		...
		try {
			...
			String insertTrxSql = " INSERT INTO `MEM_MEMBER_ACT_TRX_2016` ("
					+"`id`,"//1
					+"`trx_code`,"//2
					+"`member_id`,"//3
					+"`sub_no`,"//4
