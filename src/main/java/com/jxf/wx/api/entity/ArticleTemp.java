...
/***
 * 
 * @类功能说明： 群发图文信息时Article实体
 * @类修改者： 
 * @修改日期： 
 * @修改说明： 
 * @公司名称：北京金信服科技有限公司
 * @作者：Administrator 
 * @创建时间：2016年11月11日 下午5:13:43 
 * @版本：V1.0
 */
public class ArticleTemp extends CrudEntity<ArticleTemp> {
    ...
    public ArticleTemp(String thumbMediaId, String author, String title, String contentSourceUrl, String content, String digest, Integer showConverPic) {
