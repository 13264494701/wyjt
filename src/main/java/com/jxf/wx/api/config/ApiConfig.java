...
import com.jxf.wx.api.handle.ApiConfigChangeHandle;
import com.jxf.wx.api.response.GetJsApiTicketResponse;
...
/***
 * 
 * @类功能说明： API配置类，项目中请保证其为单例,实现观察者模式，用于监控token变化
 * @类修改者： 
 * @修改日期： 
 * @修改说明： 
 * @公司名称：北京金信服科技有限公司
 * @作者：Administrator 
 * @创建时间：2016年11月11日 下午4:36:59 
 * @版本：V1.0
 */
