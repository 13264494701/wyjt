 ...
 */
@Service
public class UfangFormAuthenticationFilter extends FormAuthenticationFilter  {
...
//		String password = getPassword(request);
		...
		password = MD5Utils.EncoderByMd5(password).toUpperCase();
		...
		return new CustomUsernamePasswordToken(username, password.toCharArray(), rememberMe, host, captcha, CustomUsernamePasswordToken.UserType.ufang);
	}
