package com.jxf.svc.persistence;
...
public class Page<T> {
	...
	public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
		...
		if (StringUtils.isNumeric(no)){
			CookieUtils.setCookie(response, "pageNo", no,"/",Global.COOKIE_MAX_AGE);
			this.setPageNo(Integer.parseInt(no));
		}else if (request.getParameter("repage")!=null){
			no = CookieUtils.getCookie(request,null,"pageNo",false);
			if (StringUtils.isNumeric(no)){
				this.setPageNo(Integer.parseInt(no));
			}
		}
		...
		if (StringUtils.isNumeric(size)){
			CookieUtils.setCookie(response, "pageSize", size,"/",Global.COOKIE_MAX_AGE);
			this.setPageSize(Integer.parseInt(size));
		}else if (request.getParameter("repage")!=null){
			no = CookieUtils.getCookie(request, null, "pageSize",false);
			if (StringUtils.isNumeric(size)){
				this.setPageSize(Integer.parseInt(size));
			}
