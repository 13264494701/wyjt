...
public class RandomUtils {
    public static final String allChar = "012345!6789abcdefg&hijklmnopq#rstuvwxyz%ABCDEFGHIJK*LMNO@PQRSTU%VWXYZ";
    public static final String letterChar = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    public static final String numberChar = "0123456789";
    public static final String luckNumberChar = "0268";
    public static final String[] CHINESE_SURNAME = { "郑", "张", "李", "刘", "肖", "高", "霍", "周", "续", "赵", "王", "孙", "吴" , "宋", "冯", "陈", "魏", "左", "贾", "杨"};
    /**
