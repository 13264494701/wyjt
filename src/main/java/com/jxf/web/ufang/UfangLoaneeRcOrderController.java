 ...
 * @version 2019-08-24
 */
@Controller("ufangLoaneeRcOrderController")
@RequestMapping(value = "${ufangPath}/ufangLoaneeRcOrder")
public class UfangLoaneeRcOrderController extends UfangBaseController {
    ...
    public String list(UfangLoaneeRcOrder ufangLoaneeRcOrder, HttpServletRequest request, HttpServletResponse response, Model model) {
        ufangLoaneeRcOrder.getSqlMap().put("dsf", UfangUserUtils.dataScopeFilter("e", "a"));
        ...
        return "ufang/order/rc/ufangLoaneeRcOrderList";
    }
    ...
    public String save(UfangLoaneeRcOrder ufangLoaneeRcOrder, Model model, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:" + ufangPath + "/ufangLoaneeRcOrder/?repage";
    }
