...
/**
 * @作者: xiaorongdian
 * @创建时间 :2019年3月6日 上午10:19:11
 * @功能说明:审核前页面 有修改父类子类都修改  AuditPage AuditAfterPage
 */
public class AuditBeforePage extends AuditPage{
	/** 首页右上角 逾期解决/催收仲裁*/
	protected String index1001 = "逾期解决";
	
	/** 首页大按钮 0逾期解决/1催收仲裁*/
	protected Integer index1002 = 0;
	
	/** 首页案例标题1 申请时间/申请人*/
	protected String index1003 = "申请时间";
	
	/** 首页案例标题2 逾期笔数/逾期天数*/
	protected String index1004 = "逾期笔数";
	...
	/** 逾期解决/催收仲裁 */
	protected String collection1101 = "逾期解决";
	
	/** 电话提醒/合法催收 */
	protected String collection1102 = "电话提醒";
	
	/** 一键裁决/法律仲裁 */
	protected String collection1103 = "一键裁决";
	
	/** 更快捷,更专业/举证出庭 */
	protected String collection1104 = "更快捷、更专业、与诉讼同等效力|#898989";
	
	/** 更快捷,更专业 */
	protected String collection1105 = "";
	
	/** 待提醒/待催收 */
	protected String collection1301 = "待提醒";
	
	/** 提醒中/催收中 */
	protected String collection1302 = "提醒中";
	
	/** 提醒结束/催收结束 */
	protected String collection1303 = "提醒结束";
	
	/** 电话提醒/专业催收 */
	protected String collection1304 = "电话提醒";
	
	/** 待裁决/待仲裁 */
	protected String collection1401 = "待裁决";
	
	/** 裁决中/仲裁中 */
	protected String collection1402 = "裁决中";
	
	/** 已出裁决/仲裁出裁决 */
	protected String collection1403 = "已出裁决";
	
	/** 裁决已完结/仲裁已完结 */
	protected String collection1404 = "裁决已完结";
	
	/** 一键裁决/法律仲裁 */
	protected String collection1405 = "一键裁决";
	...
	protected Integer mine3001 = 0;
	/** 是否显示债转中心 0否 1可以*/
	protected Integer mine3002 = 0;
	
	/** 是否显示借条中心 0否 1可以*/
	protected Integer mine3003 = 1;
	
	/** 是否显示信用检测 0否 1可以*/
	protected Integer mine3004 = 0;
	...
	/** 一键裁决/法律仲裁*/
	protected String trx4001 = "一键裁决";
	
	/** 电话提醒/专业催收*/
	protected String trx4002 = "电话提醒";
	...
	public List<ArbitrationCase> getIndex1005() {
		...
		arbitrationCase.setName("2018.12");
		arbitrationCase.setAmount("2563元");
		arbitrationCase.setDaysOverdue("3笔");
		arbitrationCase.setStatus("已解决");
		list.add(arbitrationCase);
		
		arbitrationCase = new AuditPage().new ArbitrationCase();
		arbitrationCase.setName("2018.11");
		arbitrationCase.setAmount("7562元");
		arbitrationCase.setDaysOverdue("3笔");
		arbitrationCase.setStatus("已解决");
		list.add(arbitrationCase);
		
		arbitrationCase = new AuditPage().new ArbitrationCase();
		arbitrationCase.setName("2018.10");
		arbitrationCase.setAmount("9658元");
		arbitrationCase.setDaysOverdue("6笔");
		arbitrationCase.setStatus("已解决");
		list.add(arbitrationCase);
		
		arbitrationCase = new AuditPage().new ArbitrationCase();
		arbitrationCase.setName("2018.09");
		arbitrationCase.setAmount("859元");
		arbitrationCase.setDaysOverdue("2笔");
		arbitrationCase.setStatus("已解决");
		list.add(arbitrationCase);
		return list;
	}
