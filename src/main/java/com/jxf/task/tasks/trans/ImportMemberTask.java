...
import com.jxf.transplantation.temp.member.ImportMemberUtils;
...
public class ImportMemberTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("member");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberUtils.importMember(startId,endId);    
