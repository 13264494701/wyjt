...
import com.jxf.transplantation.temp.withdraw.ImportWithdrawRecordUtils;



@DisallowConcurrentExecution
public class ImportWithdrawRecordTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {    	
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("withdraw");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportWithdrawRecordUtils.ImportWithdrawRecord(startId,endId);  		
