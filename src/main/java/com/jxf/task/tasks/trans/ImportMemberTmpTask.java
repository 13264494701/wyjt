...
import com.jxf.transplantation.temp.member.ImportMemberTmpUtils;
...
public class ImportMemberTmpTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("memberTmp");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberTmpUtils.importMember(startId,endId);    
