...
import com.jxf.transplantation.temp.member.ImportMemberPoint;
...
public class ImportMemberPointTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("point");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberPoint.importPoint(startId, endId);
