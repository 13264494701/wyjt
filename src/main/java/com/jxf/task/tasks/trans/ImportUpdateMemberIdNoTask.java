...
import com.jxf.transplantation.temp.member.ImportUpdateMemberIdNoUtils;
...
public class ImportUpdateMemberIdNoTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("memberIdNo");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportUpdateMemberIdNoUtils.importMemberVideoIdNo(startId,endId);    
