...
import com.jxf.transplantation.temp.message.ImportMessageUtils;
...
public class ImportMemberMsgTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("memberMsg");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMessageUtils.importMessage(startId,endId);    		
