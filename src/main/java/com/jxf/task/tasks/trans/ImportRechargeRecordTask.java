...
import com.jxf.transplantation.temp.recharge.ImportRechargeRecordUtils;




@DisallowConcurrentExecution
public class ImportRechargeRecordTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {    	
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("recharge");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportRechargeRecordUtils.ImportRechargeRecord(startId,endId);    
