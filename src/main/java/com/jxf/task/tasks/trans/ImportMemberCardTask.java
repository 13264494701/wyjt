...
import com.jxf.transplantation.temp.member.ImportMemberCardUtils;
...
public class ImportMemberCardTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("memberCard");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberCardUtils.importCard(startId,endId);    		
