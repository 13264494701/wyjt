...
import com.jxf.transplantation.temp.member.ImportMemberExtendUtils;
...
public class ImportMemberExtendTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("memberExtend");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberExtendUtils.importExtend(startId,endId);    
