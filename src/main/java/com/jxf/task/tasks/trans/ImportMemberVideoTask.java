...
import com.jxf.transplantation.temp.member.ImportMemberVideoVerifyUtils;
...
public class ImportMemberVideoTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("memberVideo");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberVideoVerifyUtils.importMemberVideoVerify(startId,endId);    		
