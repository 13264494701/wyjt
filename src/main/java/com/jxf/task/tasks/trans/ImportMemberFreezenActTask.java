...
import com.jxf.transplantation.temp.member.ImportMemberFreezenAct;
...
public class ImportMemberFreezenActTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("freezenAct");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberFreezenAct.importFreezenAct(startId, endId);
