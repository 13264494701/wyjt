...
import com.jxf.transplantation.temp.loan.ImportLoanRepayUtils;
...
public class ImportLoanRepayTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("loanRepay");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportLoanRepayUtils.importLoanRepay(startId, endId);    
