...
import com.jxf.transplantation.temp.member.ImportMemberResetPaypwdUtils;
...
public class ImportMemberResetPaypwdTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("resetPaypwd");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberResetPaypwdUtils.importResetPaypwd(startId, endId);   
