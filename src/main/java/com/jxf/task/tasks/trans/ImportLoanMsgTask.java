...
import com.jxf.transplantation.temp.loan.ImportLoanMessageUtils;
...
public class ImportLoanMsgTask implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("loanMsg");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportLoanMessageUtils.importLoanMessage(startId, endId);    
