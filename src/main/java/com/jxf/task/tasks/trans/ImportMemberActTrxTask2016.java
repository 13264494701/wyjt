...
import com.jxf.transplantation.temp.member.ImportMemberActTrxUtils2016;
...
public class ImportMemberActTrxTask2016 implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	SysDataImport dataImport = dataImportService.getByHandler("memberActTrx2016");
    	...
    	for(SysDataTask dataTask:taskList) {
    		...
    		int quantity = ImportMemberActTrxUtils2016.importTrx(startId,endId);    
