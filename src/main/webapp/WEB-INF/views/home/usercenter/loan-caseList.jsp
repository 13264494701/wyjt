    ...
    <div class="wrapper">
        <div class="w1">
            <div class="menus clearfix">
                ...
                <a href="javascript:;" onclick="loan_caseList()" class="hover">下载诉讼材料</a>
                <a href="javascript:;" onclick="crList()">债转借条</a>
            </div>
            <form:form id="searchForm" modelAttribute="nfsLoanRecord" action="${home}/member/loan_caseList?memberToken=${memberToken}" method="post" class="breadcrumb form-search">
                ...
                <div class="downjt">
                    ...
                    <c:forEach items="${page.list}" var="nfsLoanRecord">
                        <tr id="${nfsLoanRecord.id}" >
                            ...
                            <td><a class="down" onclick = "exportPdf(this)" target="_blank">【下载转账记录】</a>      
                            </td>
                        </tr>
                        </c:forEach>
                    </table>
...
function exportPdf(obj){
	var loanId = $(obj).closest("tr").attr("id");
	window.location.href="${home}/member/exportPdf?memberToken=${memberToken}&loanId="+loanId;
}
