...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/verified/memberVerified/query?id=${memberVerified.id}">实名认证查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="memberVerified"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:input path="realName" style="width:230px"  readonly="true" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
