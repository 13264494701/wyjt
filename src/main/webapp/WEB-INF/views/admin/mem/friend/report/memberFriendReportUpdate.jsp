...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="report:memberFriendReport:edit">
			<li class="active"><a href="${ctx}/memberFriendReport/update?id=${memberFriendReport.id}">好友投诉编辑</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="memberFriendReport" action="${ctx}/memberFriendReport/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
		<label style="text-align:right;width:150px">投诉人站内信：</label>
			<form:textarea path="memberIms" htmlEscape="false" rows="4" maxlength="1024" class="input-xxlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
		<label style="text-align:right;width:150px">被投诉人站内信：</label>
			<form:textarea path="friendIms" htmlEscape="false" rows="4" maxlength="1024" class="input-xxlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="report:memberFriendReport:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
