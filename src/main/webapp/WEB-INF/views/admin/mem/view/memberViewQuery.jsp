...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/view/memberView/query?id=${memberView.id}">会员视图查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="memberView"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:input path="orgPassword" style="width:230px"  readonly="true" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<form:input path="friendQuantity" style="width:230px"  readonly="true" htmlEscape="false" maxlength="20" class="input-xlarge  digits"/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
