...
<body>
	...
	<form:form id="inputForm" modelAttribute="memberAct" action="${admin}/memberAct/reduceActBal" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label style="text-align:right;width:150px">减款备注：</label>
