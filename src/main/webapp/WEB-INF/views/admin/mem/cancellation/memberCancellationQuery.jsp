...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/memberCancellation/">会员注销申请列表</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="memberCancellation"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:option value="" label="请选择"/>
				<form:options items="${fns:getDictLabel(memberCancellation.status, 'cancellationStatus', '')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
			</form:select>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
