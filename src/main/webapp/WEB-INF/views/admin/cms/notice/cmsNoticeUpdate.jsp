...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="notice:cmsNotice:edit">
			<li class="active"><a href="${ctx}/cmsNotice/update?id=${cmsNotice.id}">通知修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cmsNotice" enctype="multipart/form-data" action="${ctx}/cmsNotice/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<form:input path="title" style="width:650px" htmlEscape="false" maxlength="255" class="input-xlarge required"/>
