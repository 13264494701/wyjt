...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cms/category/query?id=${category.id}&parent.id=${category.parent.id}">栏目查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="category" action="${ctx}/cms/category/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="category" name="parent.id" value="${category.parent.id}" labelName="parent.name" labelValue="${category.parent.name}"
					title="栏目" url="/cms/category/treeData" extId="${category.id}" disabled="disabled" cssClass="required"/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="alias" htmlEscape="false" maxlength="50" readonly="true"  class="input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sort" htmlEscape="false" maxlength="11" readonly="true"  class="required digits"/>
