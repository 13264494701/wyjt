...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="cms:adPosition:edit">
			<li class="active"><a href="${ctx}/adPosition/update?id=${cmsAdPosition.id}">广告位置修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cmsAdPosition" action="${ctx}/adPosition/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label style="text-align:right;width:150px">编号：</label>
			<form:input path="positionNo" style="width:230px" htmlEscape="false" maxlength="64" readonly="true" class="input-xlarge required"/>
		...
		<div class="control-group"  style="text-align:center">
		    <shiro:hasPermission name="ads:adPosition:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
