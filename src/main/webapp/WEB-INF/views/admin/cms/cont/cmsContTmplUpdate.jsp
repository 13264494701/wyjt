...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="cont:cmsContTmpl:edit">
			<li class="active"><a href="${ctx}/cms/contTmpl/update?id=${cmsContTmpl.id}">协议修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cmsContTmpl" action="${ctx}/cms/contTmpl/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<form:input path="title" style="width:230px" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label style="text-align:right;width:150px" class="control-label" >协议内容：</label>
		...
		<div class="control-group">
			...
			<input name="validTime" type="text" style="width:230px"  maxlength="20" class="input-medium Wdate "
			...
			<input name="invalidTime" type="text" style="width:230px"  maxlength="20" class="input-medium Wdate "
