...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cms/cmsArticle/add?id=${cmsArticle.id}">文章添加</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cmsArticle" action="${ctx}/cms/cmsArticle/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
            ...
            <sys:treeselect id="categoryId" name="category.id" value="${article.category.id}" labelName="category.name" labelValue="${article.category.name}" cssStyle="width:185px"
					title="栏目" url="/cms/category/treeData"  notAllowSelectRoot="false" notAllowSelectParent="false" cssClass="required"/>
            <span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
