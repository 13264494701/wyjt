...
<head>
	...
	<script type="text/javascript">
		...
		function batchPub(){
			...
			$.ajax({
				type : 'POST',
				url : '${ctx}/cms/cmsArticle/batchPub',
				data : data,
				success : function(rsp) {
					top.$.jBox.tip(rsp.message);  						
				}
			})
			$("#btnBatchPub").attr("disabled",true);
	    }
	</script>
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/cmsArticle/waitPub">文章列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="cmsArticle" action="${ctx}/cms/cmsArticle/waitPub" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns">
			   ...
			   <input id="btnwaitPub" class="btn btn-primary" style="width:80px;" type="submit"  value="查&nbsp;&nbsp;&nbsp;询"/>
			   <span class="help-inline"  style="width:30px"></span>
			   <input id="btnBatchPub" class="btn btn-primary" style="width:80px;" type="button" onclick="batchPub()" value="发&nbsp;&nbsp;&nbsp;布"/>
