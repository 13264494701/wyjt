...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cms/iconPosition/add?id=${iconPosition.id}">图标位置添加</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cmsIconPosition" action="${ctx}/cms/iconPosition/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">图标位编号：</label>
			<form:input path="positionNo" style="width:230px" htmlEscape="false" maxlength="4" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<form:input path="height" style="width:230px" htmlEscape="false" maxlength="11" class="input-xlarge required digits"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
			<label style="text-align:right;width:150px">宽度：</label>
			<form:input path="width" style="width:230px" htmlEscape="false" maxlength="11" class="input-xlarge required digits"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
		...
		<div class="control-group"  style="text-align:center">
			<shiro:hasPermission name="cms:iconPosition:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
