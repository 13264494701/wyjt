...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${admin}/sys/brn/list">机构列表</a></li>
		<li class="active"><a href="${admin}/sys/brn/form?id=${brn.id}&parent.id=${brn.parent.id}">机构<shiro:hasPermission name="sys:brn:edit">${not empty brn.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:brn:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="brn" action="${admin}/sys/brn/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
