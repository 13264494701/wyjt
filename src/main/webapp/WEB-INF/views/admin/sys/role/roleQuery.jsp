...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${admin}/sys/role/formQuery?id=${role.id}">角色<shiro:hasPermission name="sys:role:edit">${not empty role.id?'查看':'查看'}</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
...
<%-- 		<div class="control-group">
			...
			<div class="controls">
				<form:select path="roleType" class="input-medium"  disabled="true"  style="width:245px">
