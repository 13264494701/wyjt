...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${admin}/sys/user/add?id=${user.id}">员工添加</a></li>
	</ul><br/>
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="brn" name="brn.id" value="${user.brn.id}" labelName="brn.brnName" labelValue="${user.brn.brnName}"
					title="部门" baseUrl="${admin}" url="/sys/brn/treeData?type=2" cssClass="required" notAllowSelectParent="true"/>
			</div>
		</div> 
		<div class="control-group">
