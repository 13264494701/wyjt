...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/app/appInst/query?id=${appInst.id}">应用激活查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="appInst"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">系统类型：</label>
			<form:input path="osType" style="width:230px"  readonly="true" htmlEscape="false" maxlength="16" class="input-xlarge "/>
