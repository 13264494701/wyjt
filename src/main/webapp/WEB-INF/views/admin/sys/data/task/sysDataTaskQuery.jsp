...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/task/sysDataTask/query?id=${sysDataTask.id}">批次任务查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysDataTask"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:input path="quantity" style="width:230px"  readonly="true" htmlEscape="false" maxlength="11" class="input-xlarge  digits"/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<form:input path="version" style="width:230px"  readonly="true" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
