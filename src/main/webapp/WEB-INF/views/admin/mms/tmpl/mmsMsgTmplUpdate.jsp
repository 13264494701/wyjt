...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/msgTmpl/">消息模板列表</a></li>
		<shiro:hasPermission name="tmpl:mmsMsgTmpl:edit">
			<li class="active"><a href="${ctx}/msgTmpl/update?id=${mmsMsgTmpl.id}">消息模板修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="mmsMsgTmpl" action="${ctx}/msgTmpl/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">模板识别码：</label>
			<form:input path="code" style="width:230px" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tmpl:mmsMsgTmpl:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
