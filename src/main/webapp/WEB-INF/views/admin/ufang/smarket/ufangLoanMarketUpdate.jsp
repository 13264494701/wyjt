...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="smarket:ufangLoanMarket:edit">
			<li class="active"><a href="${admin}/ufangLoanMarket/update?id=${ufangLoanMarket.id}">贷超修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ufangLoanMarket" action="${admin}/ufangLoanMarket/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<form:input path="name" style="width:230px" htmlEscape="false" maxlength="100" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<form:radiobuttons path="isMarketable" items="${fns:getDictList('trueOrFalse')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
	        <span class="help-inline"  style="width:168px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
