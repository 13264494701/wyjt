...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#inputForm").validate({
				rules: {
					name: {remote: "${admin}/ufang/role/checkName?oldName=" + encodeURIComponent("${role.roleName}")}
				},
				messages: {
					name: {remote: "角色名已存在"}
				},
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${admin}/ufang/role/form?id=${role.id}">角色修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="role" action="${admin}/ufang/role/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ufang:role:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
