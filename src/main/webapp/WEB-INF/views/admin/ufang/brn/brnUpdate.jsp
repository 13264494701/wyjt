...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${admin}/ufang/brn/update?id=${brn.id}&parent.id=${brn.parent.id}">机构修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="brn" action="${admin}/ufang/brn/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="grade"   id="brnGrade"  style="width:265px;" class="input-medium required">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="phoneNo" htmlEscape="false" style="width:250px;" maxlength="11" class="digits"/>
