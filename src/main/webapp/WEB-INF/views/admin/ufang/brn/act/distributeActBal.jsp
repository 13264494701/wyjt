				...
				submitHandler: function(){
					...
					$.ajax({
						...
						success:function(res){							
				          if(res.type=='success'){
				        	  showTip(res.content);				        	
				        	  var d = parent.dialog.get('distributeActBal');	
				        	  setTimeout(function(){  
				        		  d.close(res.type); 
				        		  }
				        	  ,2000);//单位毫秒   
...
<body>
	...
	<form:form id="inputForm" modelAttribute="ufangBrnAct" action="${admin}/ufangBrnAct/distributeActBal" method="post" class="form-horizontal">
		<form:hidden path="id"/>
