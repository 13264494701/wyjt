...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${admin}/ufang/brn/query?id=${brn.id}&parent.id=${brn.parent.id}">机构查看</a></li>
	</ul><br/>
	 		...
	 		<div class="control-group">
				...
				<div class="controls">
	                <sys:treeselect  id="brn" name="parent.id" value="${brn.parent.id}" labelName="parent.brnName" labelValue="${brn.parent.brnName}"
						title="机构" baseUrl="${admin}" url="/ufang/brn/treeData" extId="${brn.id}" cssClass="" allowClear="false" disabled="disabled"/> 
				</div>
			</div>
		</c:if>
		<div class="control-group">
 		...
 		<div class="control-group">
			...
			<div class="controls">
				<form:select path="grade"  disabled="true"  style="width:265px;" class="input-medium required">
