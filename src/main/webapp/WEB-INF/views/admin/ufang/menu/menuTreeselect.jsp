...
<script type="text/javascript"> 
	...
	var menuTreeselectNodes=[
			...
			</c:forEach>{id:new Date().getTime(), pId:"0", name:"<i class=\"icon-home\"></i>&nbsp;进入主页", url:"${admin}", target:"_self"},
			{id:new Date().getTime(), pId:"0", name:"<i class=\"icon-share\"></i>&nbsp;退出登录", url:"${admin}/logout", target:"_self"}];
