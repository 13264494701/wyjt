...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ufangbrnfundaddreducce/ufangFundAddReduce/">优放机构加减款记录列表</a></li>
		<shiro:hasPermission name="ufangbrnfundaddreducce:ufangFundAddReduce:edit">
			<li class="active"><a href="${ctx}/ufangbrnfundaddreducce/ufangFundAddReduce/update?id=${ufangFundAddReduce.id}">优放机构加减款记录修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ufangFundAddReduce" action="${ctx}/ufangbrnfundaddreducce/ufangFundAddReduce/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">公司ID：</label>
			<form:input path="brnId" style="width:230px" htmlEscape="false" maxlength="20" class="input-xlarge required digits"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ufangbrnfundaddreducce:ufangFundAddReduce:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
