...
<h1>
	...
	<form:form id="searchForm" modelAttribute="rcShandie" action="${admin}/rcShandie" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="rcShandie">
			<tr>
				<td style="text-align:center">
					<a href="${admin}/rcShandie/query?id=${rcShandie.id}">
						${rcShandie.name}
					</a>
				</td>
				<td style="text-align:center">
				...
				<shiro:hasPermission name="ufang:rcShandie:view">
    				<a href="${admin}/rcShandie/query?id=${rcShandie.id}">查看报告</a>
				</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
