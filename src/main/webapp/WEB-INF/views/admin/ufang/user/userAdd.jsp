...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					username: {remote: "${admin}/ufang/user/checkUsername"}
				},
				messages: {
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${admin}/ufang/user/add?id=${user.id}">员工添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${admin}/ufang/user/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="brn" name="brn.id" value="${user.brn.id}" labelName="brn.brnName" labelValue="${user.brn.brnName}"
					title="部门"  baseUrl="${admin}" url="/ufang/brn/treeData" cssClass="required" notAllowSelectParent="true"/>
			</div>
		</div> 
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="username" style="width:253px" htmlEscape="false" maxlength="11" class="required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="email" style="width:253px" htmlEscape="false" maxlength="100" class="email"/>
			</div>
		</div>
		<div class="control-group">
