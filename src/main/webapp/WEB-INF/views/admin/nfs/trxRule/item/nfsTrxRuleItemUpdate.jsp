...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/nfsTrxRuleItem/?trxCode=${nfsTrxRuleItem.trxCode}">交易规则列表</a></li>
		<shiro:hasPermission name="trx:nfsTrxRuleItem:edit">
			<li class="active"><a href="${ctx}/nfsTrxRuleItem/update?id=${nfsTrxRuleItem.id}">交易规则修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsTrxRuleItem" action="${ctx}/nfsTrxRuleItem/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<form:select path="subNo" style="width:245px" class="input-xlarge required">
				<form:option value="" label="请选择"/>
				<form:options items="${fns:findSubsByTrxRole(nfsTrxRuleItem.trxRole)}" itemLabel="name" itemValue="subNo" htmlEscape="false"/>
			</form:select>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		...
		<div class="control-group">
			...
			<form:input path="title" style="width:245px" htmlEscape="false" maxlength="255" class="input-xlarge"/>
			<span class="help-inline"  style="width:150px"> </span>
		</div>
		
		<div class="control-group">
			<label style="text-align:right;width:150px">流水组(前台展示)：</label>
			<form:select path="trxGroup" style="width:245px" class="input-xlarge required">
		...
		<div class="control-group">
			...
			<form:input path="rmk" style="width:630px" htmlEscape="false" maxlength="255" class="input-xlarge"/>
			<span class="help-inline"  style="width:150px"> </span>
		</div>
