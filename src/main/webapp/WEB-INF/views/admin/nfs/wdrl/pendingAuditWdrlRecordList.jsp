...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/wdrl/nfsWdrlRecord/">提现记录待审核列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="nfsWdrlRecord" action="${ctx}/wdrlRecord/findPendingAuditRecord" method="post" class="breadcrumb form-search">
