...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/fundaddreduce/nfsFundAddReduce/">会员加减款记录列表</a></li>
		<shiro:hasPermission name="fundaddreduce:nfsFundAddReduce:edit">
			<li class="active"><a href="${ctx}/fundaddreduce/nfsFundAddReduce/update?id=${nfsFundAddReduce.id}">会员加减款记录修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsFundAddReduce" action="${ctx}/fundaddreduce/nfsFundAddReduce/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fundaddreduce:nfsFundAddReduce:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
