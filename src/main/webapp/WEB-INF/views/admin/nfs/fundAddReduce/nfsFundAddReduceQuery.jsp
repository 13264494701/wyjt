...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/fundaddreduce/nfsFundAddReduce/query?id=${nfsFundAddReduce.id}">会员加减款记录查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsFundAddReduce"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
