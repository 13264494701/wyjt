...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sub:nfsActSub:edit">
			<li class="active"><a href="${ctx}/nfsActSub/update?id=${nfsActSub.id}">账户科目修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsActSub" action="${ctx}/nfsActSub/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">业务角色：</label>			
			<form:select path="trxRole" class="input-xlarge required">
		...
		<div class="control-group">
			...
			<form:input path="name" style="width:230px" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="sub:nfsActSub:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
