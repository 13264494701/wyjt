...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/bank/nfsBankProtocol/add?id=${nfsBankProtocol.id}">签约协议添加</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsBankProtocol" action="${ctx}/bank/nfsBankProtocol/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<form:input path="paymentPluginId" style="width:230px" htmlEscape="false" maxlength="127"0 class="input-xlarge required digits"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
