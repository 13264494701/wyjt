...
<ul class="nav nav-tabs">
    <li class="active"><a href="${admin}/recharge/">充值记录</a></li>
</ul>
<form:form id="searchForm" modelAttribute="ufangRchgRecord" action="${admin}/recharge/" method="post"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        <td style="text-align:center" colspan="4">总计：${ufang:decimalToStr(amount,2)}</td>
    </tr>
    </tbody>
</table>
