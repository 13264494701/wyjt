...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/quota/quota/rcQuota/query?id=${rcQuota.id}">会员额度查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="rcQuota"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:input path="quota" style="width:230px"  readonly="true" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
			<label style="text-align:right;width:150px">综合评分：</label>
			<form:input path="score" style="width:230px"  readonly="true" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
