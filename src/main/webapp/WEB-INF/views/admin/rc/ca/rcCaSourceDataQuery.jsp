...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/ca/rcCaSourceData/query?id=${rcCaSourceData.id}">信用报告原始数据表查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="rcCaSourceData"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
