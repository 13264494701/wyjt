...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/ca/rcXinyan/query?id=${rcXinyan.id}">新颜雷达报告查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="rcXinyan"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">优放用户：</label>
			<form:input path="ufangEmpNo" style="width:230px"  readonly="true" htmlEscape="false" maxlength="8" class="input-xlarge "/>
		...
		<div class="control-group">
			...
			<form:input path="result" style="width:230px"  readonly="true" htmlEscape="false" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
			<label style="text-align:right;width:150px">是否是自己支付的：</label>
			<form:input path="isSelfbuy" style="width:230px"  readonly="true" htmlEscape="false" maxlength="1" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
