...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/ca/rcCaData/query?id=${rcCaData.id}">信用报告数据表查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="rcCaData"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label style="text-align:right;width:150px">数据来源类型 </label>
			<form:select path="type" style="width:245px"  disabled="true"  class="input-xlarge ">
			<form:option value="" label="请选择"/>
				<form:options items="${fns:getDictList('acType')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
			</form:select>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
