...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/loan/preservation/nfsLoanPreservation/add?id=${nfsLoanPreservation.id}">业务保全添加</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsLoanPreservation" action="${ctx}/loan/preservation/nfsLoanPreservation/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<form:input path="loan.id" style="width:230px" htmlEscape="false" maxlength="20" class="input-xlarge  digits"/>
