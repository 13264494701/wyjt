...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="loan:nfsLoanPartialAndDelay:edit">
			<li class="active"><a href="${ctx}/loan/nfsLoanPartialAndDelay/update?id=${nfsLoanPartialAndDelay.id}">部分还款和延期修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsLoanPartialAndDelay" action="${ctx}/loan/nfsLoanPartialAndDelay/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:input path="memberRole" style="width:230px" htmlEscape="false" maxlength="4" class="input-xlarge required"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<form:input path="partialAmount" style="width:230px" htmlEscape="false" class="input-xlarge required"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
			<label style="text-align:right;width:150px">部分还款后剩余应还金额：</label>
			<form:input path="remainAmount" style="width:230px" htmlEscape="false" class="input-xlarge required"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<input name="repayDateAfterDelay" type="text" style="width:230px" readonly="readonly" maxlength="20" class="input-medium Wdate "
		...
		<div class="control-group">
			...
			<form:input path="delayDays" style="width:230px" htmlEscape="false" maxlength="11" class="input-xlarge required"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="loan:nfsLoanPartialAndDelay:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
