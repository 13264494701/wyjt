...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="collection:nfsLoanCollectionDetail:edit">
			<li class="active"><a href="${ctx}/collection/nfsLoanCollectionDetail/update?id=${nfsLoanCollectionDetail.id}">催收明细修改</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsLoanCollectionDetail" action="${ctx}/collection/nfsLoanCollectionDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">借条编号：</label>
			<form:input path="collectionId" style="width:230px" htmlEscape="false" maxlength="20" class="input-xlarge required digits"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="collection:nfsLoanCollectionDetail:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
