...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/arbitration/nfsLoanArbitrationDetail/query?id=${nfsLoanArbitrationDetail.id}">仲裁明细查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsLoanArbitrationDetail"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">借条编号：</label>
			<form:input path="arbitrationId" style="width:230px"  readonly="true" htmlEscape="false" maxlength="20" class="input-xlarge  digits"/>
