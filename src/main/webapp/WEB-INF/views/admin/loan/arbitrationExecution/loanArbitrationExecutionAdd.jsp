...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="arbitrationexecution:借条强执增删改查:nfsLoanArbitrationExecution:edit">
		<li class="active"><a href="${ctx}/arbitrationexecution/借条强执增删改查/nfsLoanArbitrationExecution/add?id=${nfsLoanArbitrationExecution.id}">操作成功添加</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="nfsLoanArbitrationExecution" action="${ctx}/arbitrationexecution/借条强执增删改查/nfsLoanArbitrationExecution/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label style="text-align:right;width:150px">借条编号：</label>
			<form:input path="loanNo" style="width:230px" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<input name="rulingtime" type="text" style="width:230px" readonly="readonly" maxlength="20" class="input-medium Wdate "
		...
		<div class="control-group">
			<label style="text-align:right;width:150px">借条编号：</label>
			<form:input path="loan.id" style="width:230px" htmlEscape="false" maxlength="20" class="input-xlarge required digits"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="arbitrationexecution:借条强执增删改查:nfsLoanArbitrationExecution:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
