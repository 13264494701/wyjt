            ...
            <div class="page">
                <div class="page-content user-main withdraw-main " style="background:RGB(238,242,243);padding-bottom:1rem;    padding-top: 0;">
                   ...
                   <form id="dataForm" action="" method="post">
	                    ...
	                    <input type="hidden" id="isVideo" name="isVideo"/>
                   </form>
                </div>
            </div>
        </div>
    ...
    define('loanPayYXB', ['zepto', 'jumpApp','panel'], function (require, exports, module) {
       ...
       $sub[ev](function () {
							                ...
							                callback: function (code, msg) {
								                ...
								                if (code) {
								                     $.toast('支付申请成功', 1000, function () {
									                        ...
									                        if(isVideo == '1'){
										                    	//放款人要求录视频
											                    $("#dataForm").attr("action",'${pageContext.request.contextPath}/app/wyjt/loan/loanerRequireVideo');
									                    	}else{
									                    		if(loanType == '1'){
									                    			 //多人借款
												                     $("#dataForm").attr("action",'${pageContext.request.contextPath}/app/wyjt/loan/payForMultiplayerLoan');
										                    	}else{
										                    		 $("#dataForm").attr("action",'${pageContext.request.contextPath}/app/wyjt/loan/payForAgreeLoan');
										                    	}
									                    	}
										                    $("#dataForm").submit();
								                         });
        ...
        function goDetails() {
        	...
        	location.href = url + "&applyId=" + applyId;
        }
