...
<%
    ...
    String parmName = "";
    if (null == parm) parm = "czsm";
    if ("czsm".equals(parm)) parmName = "充值说明";
    else if ("cjwt".equals(parm)) parmName = "常见问题";
    else if ("aqbz".equals(parm)) parmName = "安全保障";
    else if ("sfrz".equals(parm)) parmName = "身份认证";
    else if ("zhzc".equals(parm)) parmName = "账号注册";
    else if ("hyjk".equals(parm)) parmName = "好友借款";
    else if ("cztx".equals(parm)) parmName = "充值提现";
    else if ("csfw".equals(parm)) parmName = "催收服务";
%>
<!DOCTYPE html>
<html>
<head>
...
<article class="views" style="height: 120vh">
    <section class="view">
        <div class="pages">
            <div class="page">
                <div class="page-content">
                    <div class="ques-con" style="padding-bottom: 2rem;overflow: hidden;">
                        ...
                        <%} else if ("hyjk".equals(parm)) {%>

                        <h2>1、如何借款？</h2>

                        <p>账户登录 <span class="bold">--></span> 点击首页“我要借款”顺序操作<span class="bold">--></span>找好友借款<span
                                class="bold">--></span>交流页。</p>
                        <p>（注：需要好友下载无忧借条APP 相互加为好友）</p>

                        <h2>2、如何还款？</h2>

                        <p>点击首页右下角“我的”<span class="bold">--></span> 借条中心<span class="bold">--></span>我欠谁钱<span
                                class="bold">--></span>点击订单<span class="bold">--></span>我要还款。</p>
                        ...
                        <%} else if ("zhzc".equals(parm)) {%>

                        <h2>如何注册？</h2>

                        <p>下载客户端<span class="bold">--></span>点击首页右下角“我的”<span class="bold">--></span>注册登录<span
                                class="bold">--></span>身份验证（可以点击右上角“跳过”）。</p>
                        <br/>
                        <p>下载网址：<a href="/app/wyjt/common/download" target="_blank">http://www.51jt.com</a>或者关注微信公众号“无忧借条官网”-“阅读全文”下载。
                        </p>


                        <%} else if ("sfrz".equals(parm)) {%>
                        ...
                        <%} else if ("czsm".equals(parm)) {%>

                        <h2>如何充值？</h2>

                        <p>
                            1.支付宝和微信充值无限额，如出现限额提示，是您所绑定银行卡的支付额限制，可联系银行客服或在银行官方网站上修改网上支付限额。充值姓名必须要与在本站绑定真实信息一致，以免耽误您提现。</p>
