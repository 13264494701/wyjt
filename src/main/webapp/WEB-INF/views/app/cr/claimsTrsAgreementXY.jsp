...
<body>
<h2 align="center" ><strong>债权转让协议</strong></h2>
                        <p align="center">
                        ...
                        <p>
                            借款利率	<strong>年化${loanRecord.intRate}%</strong>
                        </p>
                        <p>
                            还款方式	<strong>借款期限届满后一次性偿还本金和利息</strong>
                        </p>
                        <p>
                        ...
                        <p>身份证号码：<strong>${seller.idNo}</strong></p>
                        <p>乙方：<strong>${buyer.name}</strong></p>
                        <p>身份证号码：<strong>${buyer.idNo}</strong></p>
