...
<head>
    ...
    <style>
        ...
        .speedList p {
            background: url(${mbStatic}/assets/images/debt/graySpeed@3x.png) 6.8rem 0rem no-repeat;
            background-size: 8%;
            padding-bottom: 1.5rem
        }

        .speedList p:first-child {
            background: url("${mbStatic}/assets/images/debt/speed@3x.png") 6.5rem 0rem no-repeat;
            background-size: 10%;
        }
        ...
        .speedList p:last-child {
            background: url("${mbStatic}/assets/images/debt/graySpeedUp@3x.png") 6.8rem 0rem no-repeat;
            background-size: 8%;
        }
