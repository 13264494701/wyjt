...
<head>
    ...
    <link rel="stylesheet" href="/wap/assets/css/public.css?v=<%=version%>" type="text/css">
    <link rel="stylesheet" href="/wap/assets/css/helpcenter.css?v=<%=version%>" type="text/css">
    <script src="/wap/assets/scripts/sea-modules/seajs/2.3.0/sea.js?v=<%=version%>"></script>
    <script src="/wap/assets/scripts/base/flexible.js?v=<%=version%>"></script>
    <style>
        .red {
            color: red;
        }
            ...
            <div class="page">
                <div class="page-content" style="padding-top: 0;">
                    <div class="ques-con">
                        <%--<div class="topnav">--%>
                            <%--<div class="top-tel">--%>
                                <%--<a href="tel:4006688658">--%>
                                    <%--<div class="animate"><img src="<%=cdnUrl%>images/acts/ser_tel.png?v=">--%>
                                    <%--</div>--%>
                                    <%--<p>400-6688-658</p></a>--%>
                            <%--</div>--%>
                            <%--<div class="top-kf">--%>
                                <%--<a href="http://www.51jt.com/wap/tqkf.jsp?pt=ios" style="display: block">--%>
                                    <%--<div class="animate animate1"><img src="<%=cdnUrl%>images/acts/ser_kf.png"></div>--%>
                                    <%--<p>在线客服</p></a>--%>
                            <%--</div>--%>
                        ...
                        <%----%>
                        <%--<style>--%>
                        <%--.page-content .ques-con .red{color: red;}--%>
                        <%--.ques-con{overflow: hidden;}--%>
                        <%--.titleTel{font-weight: bold;}--%>
                        <%--</style>--%>
                        <%--&lt;%&ndash;<a href="http://www.51jt.com/wap/tqkf.jsp?pt=<%=appPlatform%>" class="linka"></a><a href="tel:400-6688-658" class="linka linka1"></a><img style="margin-bottom: 1rem" src="/wap/assets/images/user-kf@1x.png">&ndash;%&gt;--%>
                        <%--<div style="background-image: url('/wap/assets/images/user-kf@1x.png');width:31.95rem;height: 6.45rem;background-size: 145% 100%;background-repeat: no-repeat; " >  <a href="http://www.51jt.com/wap/tqkf.jsp?pt=<%=appPlatform%>" class="linka" style="width: 100%;"></a></div>--%>
                        <%--<div style="margin: .5rem 0 1rem 2rem;">--%>
                        <%--<p>客服电话：<a href="tel:4006688658" class="titleTel">4006688658</a></p>--%>
                        <%--<p>（工作时间：9:00-21:00）</p>--%>
                        <%--</div>--%>
                        <div class="quetit"><span>常见问题</span></div>
                        <h2>1、如何注册/登录？ </h2>

                        <p>应用市场下载无忧借条APP<span class="bold">--></span>点击首页右下角“我的”<span class="bold">--></span>注册登录<span class="bold">--></span>身份验证（可以点击右上角“跳过”）。</p>
                        <p>下载网址：<a href="/app/wyjt/common/download" target="_blank">http://www.51jt.com</a>关注微信公众号“无忧借条服务”-“阅读全文”下载。</p>
                        ...
                        <p>d.认证扫描失败的原因：</p>
                            ...
                            <p style="text-indent:2em;">③设备问题：手机摄像头像素太低，无法聚焦，建议摄像头像素 500 万以上；单个程序内存占用过大，未及时释放，可用内存过少（和手机本身内存无关）</p>
                        ...
                        <p class="bgGray">e. 如何修改绑定银行卡：</p>
                             ...
                             <p class="bgGray" style="text-indent:2em;">第一层验证：输入之前完整的绑定银行卡号；</p>
                             <p  class="bgGray"style="text-indent:2em;">第三层验证：进行人脸识别比对，对比成功后直接修改成功；对比失败结果告知用户。（如用户特殊情况无法完成可在线联系客服）</p>
                            <p class="bgGray" style="text-indent:2em;color:red;">注：同一账户享有5次/年的修改权限，超出次数不能再修改，请谨慎操作！（修改次数为一个自然年5次，即2017年如超出5次，需要等到2018年1月1日0点才能继续修改）</p>

                        <h2>3、忘记密码怎么找回？</h2>

                        <p>a. 注册手机号码在使用中：登录页面 <span class="bold">--></span>点击忘记密码<span class="bold">--></span>输入手机号码验证<span class="bold">--></span>设置新密码 。</p>
                        <p>b. 注册手机号码不在使用中：点击右上角带耳麦的小人图标，<span class="bgGray">选择上端右侧在线咨询，</span>在线提供手持身份证的正反面照片帮您处理。</p>


                        <h2>4、如何修改密码？</h2>

                        <p>点击首页右下角“我的”<span class="bold">--></span>安全中心<span class="bold">--></span>修改登录密码/手势密码/支付密码。</p>

                        <h2>5、如何借款？</h2>

                        <p>登录账户，首页“找好友借款”填写借款信息（借款金额，还款时间必填）点击下一步，进入还款设置页面（调整还款方式，利息）点击下一步，进入确认借条信息页面，核实信息没有问题选择找好友借款，发起借款申请。</p>
                        <p>注：找好友借款，好友需要下载无忧借条APP，注册账户，认证身份信息后可处理收到的借条信息，同意放款立即支付即可。</p>

                        <h2>6、如何还款？</h2>

                        <p>点击客户端首页<span class="bold">--></span>借条中心<span class="bold">--></span>我欠谁钱<span class="bold">--></span>点击订单<span class="bold">--></span>我要还款。</p>
                        <p>a、若为全额还款，可选择线下还款也可选择申请延期，线下还款需好友确认后才算还款成功；（线下还款需是双方信任的人否则存在一定风险，建议全部线上还款操作，有疑问请直接联系客服确认之后再操作。）</p>
                        <p>b、借条申请延期的次数最多为五次，申请延期默认是1个月，延期时间可自行修改，最长一年；</p>
                        <p>c、申请延期，<span class="bgGray">需在还款当天至逾期第14天之内操作，超出15天，则不能进行延期申请。（延期操作需要放款人确认才生效，请及时和放款人确定。）</span></p>
                        ...
                        <p>登录账户直接充值到无忧账户还款，借条是自动失效的，如果您已经选择了线下还款操作，请您尽量联系放款人沟通解决，如果对方恶意不确认借条，建议您保留好还款凭证和您跟放款人之间协商线下还款的相关记录，后期如有需要可以通过法律途径解决。</p>
                        ...
                        <%--<p>a. 忧借条是经过CA认证、第三方数字存证、200多家公证处认可的电子借条,具有安全性、真实性、 合法合规性的特点。</p>--%>
