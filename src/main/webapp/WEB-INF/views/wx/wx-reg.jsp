            ...
            <div class="page">
                <div class="page-content">
                    <div class="login regist">
                        <form action="/wx/wyjt/register/submit" method="post" onsubmit="return check()"
                              autocomplete="off">
                            <div class="logo"></div>
                            <div class="login-input iconinput clearfix regist-input">
                                ...
                                <p>
                                    <i class="pass"></i><input type="password" placeholder="输入8-16位数字+字母的组合" id="password"
                                                               name="password">
                                </p>

                                <p>
                                    <i class="pass-again"></i><input type="password" placeholder="再次确认" id="password1">
                                </p>
                                ...
                                <div class="agree-check">
                                    <input type="checkbox" id="agree" checked style="width: 28px;height: 28px">我同意
                                    <a href="/mb/cont/registerAgreementWechat.html">《用户注册协议》</a>
                                </div>
                            </div>
                            <div class="button">
                                <p><input class="redBtn btn-block" value="注 册" type="submit"></p>
                            </div>
                        </form>
                    </div>
                </div>
