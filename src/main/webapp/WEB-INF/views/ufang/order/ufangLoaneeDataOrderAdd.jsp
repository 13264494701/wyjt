...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="order:ufangLoaneeDataOrder:edit">
		<li class="active"><a href="${ctx}/order/ufangLoaneeDataOrder/add?id=${ufangLoaneeDataOrder.id}">流量订单添加</a></li>
		</shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ufangLoaneeDataOrder" action="${ctx}/order/ufangLoaneeDataOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:input path="dataId" style="width:230px" htmlEscape="false" maxlength="20" class="input-xlarge required digits"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<form:input path="payId" style="width:230px" htmlEscape="false" maxlength="20" class="input-xlarge required digits"/>
			<span class="help-inline"  style="width:150px"><font color="red">*</font> </span>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="order:ufangLoaneeDataOrder:edit"><input id="btnSubmit" class="btn btn-primary" style="width:80px;" type="submit" value="保   存"/>&nbsp;</shiro:hasPermission>
