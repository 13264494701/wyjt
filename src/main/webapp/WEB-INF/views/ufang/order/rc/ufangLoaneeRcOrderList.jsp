...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ufang}/ufangLoaneeRcOrder/">黑名单列表</a></li>
	</ul>	
	<form:form id="searchForm" modelAttribute="ufangLoaneeRcOrder" action="${ufang}/ufangLoaneeRcOrder/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="ufangLoaneeRcOrder">
			<tr id="${ufangLoaneeRcOrder.id}">
				...
				<td style="text-align:center">
						逾期笔数:${ufang:parseObject(ufangLoaneeRcOrder.data).overDueCnt}<br>
						逾期金额:${ufang:parseObject(ufangLoaneeRcOrder.data).overDueAmt}
				</td>
				<td style="text-align:center">
						${ufang:decimalToStr(ufangLoaneeRcOrder.price,2)}
				</td>
				<td style="text-align:center">
