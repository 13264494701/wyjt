...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ufang}/ufangBrnActTrx?company.id=${ufangBrnActTrx.company.id}">账户交易列表</a></li>		
	</ul>
	<form:form id="searchForm" modelAttribute="ufangBrnActTrx" action="${ufang}/ufangBrnActTrx?company.id=${ufangBrnActTrx.company.id}" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>归属公司：</label>
			<sys:treeselect id="company" name="company.id" value="${ufangBrnActTrx.company.id}" labelName="company.brnName" labelValue="${ufangBrnActTrx.company.brnName}"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="ufangBrnActTrx">
			<tr>
				...
				<td style="text-align:center">
					${ufangBrnActTrx.actNam}
				</td>
				<td style="text-align:center">
					${fns:getDictLabel(ufangBrnActTrx.trxType, 'trxType', '')}
				</td>
				<td style="text-align:center">
					${fns:getDictLabel(ufangBrnActTrx.actDrc, 'actDrc', '')}
				</td>
				<td style="text-align:center">
				...
				<td style="text-align:center">
					${fns:getDictLabel(ufangBrnActTrx.trxSts, 'trxSts', '')}
				</td>
				<td style="text-align:center">
