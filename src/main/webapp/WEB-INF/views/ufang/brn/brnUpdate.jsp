...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ufang}/brn/update?id=${brn.id}&parent.id=${brn.parent.id}">机构修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="brn" action="${ufang}/brn/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="phoneNo" htmlEscape="false" style="width:250px;" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
