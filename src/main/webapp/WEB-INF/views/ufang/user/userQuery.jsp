...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ufang}/user/form?id=${user.id}">员工基本信息<shiro:hasPermission name="sys:user:edit">${not empty user.id?'':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:user:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
