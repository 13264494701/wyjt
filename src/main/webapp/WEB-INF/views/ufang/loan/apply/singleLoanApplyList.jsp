...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ufang}/loanApply/singleLoanApplyList">单人申请</a></li>		
	</ul>
	<form:form id="searchForm" modelAttribute="nfsLoanApply" action="${ufang}/loanApply/singleLoanApplyList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th style="text-align:center">发起角色</th>
		...
		<c:forEach items="${page.list}" var="nfsLoanApply">
			<tr>
				...
				<td  style="text-align:center">
				<shiro:hasPermission name="ufang:loanApply:edit">
    			<a href="${ufang}/loanApply/query?id=${nfsLoanApply.id}">
					查看详情
				</a>
				</shiro:hasPermission>
				</td>
