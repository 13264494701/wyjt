...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ufang}/mine/info">个人信息</a></li>
		<li><a href="${ufang}/mine/updatePwd">修改密码</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="user" action="${ufang}/mine/info" method="post" class="form-horizontal">
		<%--
