...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/mem/memberFriendRelation/query?id=${memberFriendRelation.id}">好友关系查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="memberFriendRelation"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<form:input path="friendId" style="width:230px"  readonly="true" htmlEscape="false" maxlength="20" class="input-xlarge  digits"/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
			<label style="text-align:right;width:150px">好友用户名(手机号)：</label>
			<form:input path="friendName" style="width:230px"  readonly="true" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
			<label style="text-align:right;width:150px">关系状态 0：被邀请，1：好友：</label>
			<form:select path="relationType" style="width:245px"  disabled="true"  class="input-xlarge ">
		...
		<div class="control-group">
			...
			<form:input path="friendnickname" style="width:230px"  readonly="true" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
		<div class="control-group">
			<label style="text-align:right;width:150px">好友真实姓名：</label>
			<form:input path="friendrealname" style="width:230px"  readonly="true" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			<span class="help-inline"  style="width:150px"></span>	
		</div>
