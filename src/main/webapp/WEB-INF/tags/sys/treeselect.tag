...
<%@ attribute name="baseUrl" type="java.lang.String" required="true" description="当前根路径"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		top.$.jBox.open("iframe:${baseUrl}/tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}", "选择${title}", 300, 420, {
